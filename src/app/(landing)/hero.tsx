...
export function Hero() {
  return (
    <Element name="hero">
      <section className="relative px-1 py-20 bg-black-100 mx-2 lg:mx-20 md:mx-20">
      
        <div className="flex flex-col justify-center items-center mt-5 mb-5 md:mt-28 md:mb-40 lg:mt-28 lg:mb-40 h-[700px]">
          <h2
            className={`text-[35px] md:text-[45px] lg:text-[45px] font-normal max-w-[980px] text-center ${monasans.className}`}
          >
            Founded in{" "}
            <span className="text-green-700 text-[35px] md:text-[45px] lg:text-[45px] font-extrabold">2010</span> with the
            goal of providing the best quality fruits and vegetables.
          </h2>
          <h4 className={`text-[18px] md:text-[20px] lg:text-[20px] font-normal max-w-2xl text-center mt-7 text-[#677085] ${monasans.className}`}>
